# Generated by Django 2.2.7 on 2019-11-21 22:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('n_def', models.IntegerField(default=0)),
                ('n_atac', models.IntegerField(default=0)),
                ('n_cent', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('tactic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appEball.Tactic')),
            ],
            options={
                'verbose_name': 'Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('posicao', models.CharField(choices=[('Goalkeeper', 'Goalkeeper'), ('Defender', 'Defender'), ('Mildfielder', 'Mildfielder'), ('Foward', 'Foward'), ('Striker', 'Striker')], default=None, max_length=100)),
                ('saldo', models.IntegerField(default=0)),
                ('nrGolos', models.IntegerField(default=0)),
                ...
                ('equipa', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='appEball.Team')),
